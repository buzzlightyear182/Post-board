...
ActiveRecord::Schema.define(version: 20141121130942) do
  ...
  add_index "posts", ["content_type", "content_id"], name: "index_posts_on_content_type_and_content_id", using: :btree
